...
* **Subset Handled:** We parse the raw text/CSV, but deliberately ignore deep metadata (like SAP Company Codes or Hotel Tax structures) to focus strictly on emissions-generating activity quantities.

## 2. Ambiguity: Defining an "Anomaly" without Historical Data
...
## 3. Ambiguity: The Analyst vs Auditor UX (10% Weight)
